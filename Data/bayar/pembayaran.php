...
<div class="container mt-2">
    ...
    <?php if (isset($_GET['pesan'])): ?>
        <div class="alert alert-success alert-dismissible fade show">
            <?php 
            if ($_GET['pesan'] == 'tambah') echo "✅ Data pembayaranberhasil ditambahkan!";
            if ($_GET['pesan'] == 'edit') echo "✅ Data pembayaranberhasil diperbaharui!";
            if ($_GET['pesan'] == 'hapus') echo "✅ Data pembayaranberhasil dihapus!";
            ?>
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="bayar_tambah.php" class="btn btn-primary">+ Tambah pembayaran</a>
    </div>
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="bayar_edit.php?id=<?= $row['id_pembayaran'] ?>" class="btn btn-sm btn-warning">Edit</a>
                            <a href="bayar_hapus.php?id=<?= $row['id_pembayaran'] ?>" 
